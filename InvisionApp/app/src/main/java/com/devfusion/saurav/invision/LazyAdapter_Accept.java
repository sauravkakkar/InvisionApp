 ...
 */
public class LazyAdapter_Accept extends BaseAdapter {
    ...
    public LazyAdapter_Accept(Activity activity,ArrayList<HashMap<String,String>> d)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (cview == null)
        {
            ...
            cview = inflater.inflate(R.layout.row_list_accept, null);
